...
//	    static  final int MAX_WORKING_HOURS = 100;
	    ...
	    private int totalEmpWage;
	     ...
	     public EmpWageUc9 (String company, int empRatePerHour, int numOfWorkingDays, int maxHoursPerMonth) {
	    ...
	    public static void main(String[] args) {
	        ...
	        EmpWageUc9 jio = new EmpWageUc9("jio", 20,2, 10);
	        EmpWageUc9 DMart = new EmpWageUc9("DMart", 10, 4, 20);
	        jio.computeEmpWage();
